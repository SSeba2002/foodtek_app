          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                bool isSelected = selectedCategory == categories(context)[index] ||
                    (categories(context)[index] == AppLocalizations.of(context)!.all &&
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        if (categoryIcons[categories(context)[index]]!.isNotEmpty) ...[
                          Text(
                  ...
                  if (state is TopRatedLoading) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return CategoryCell(
                          onAddTap: () {
                            cartItems(context).add(CartItem.fromTopRatedItem(item));
                            setState(() {});
                          },
                          isRecommended: false,
                          cObj: isArabic ? item.nameAr ?? '' : item.nameEn ?? '',
                          image: item.image ?? '',
