            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Price Range',
                    style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w600, color: Color(0xFF98A0B4)),
                  ),
                  SizedBox(height: 8.h),
                  Row(
                    children: [
                        ...
                        child: TextField(
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                              borderSide: BorderSide(color: Color(0xFF25AE4B), width: 1.0),
                            ),
                  ...
                  Stack(
                    children: [
                      RangeSlider(
                        ...
                        labels: RangeLabels('${_priceRange.start} JD', '${_priceRange.end} JD'),
                      ...
                      Positioned(
                        left: 0,
                        bottom: 32,
                        child: Text('0 JD', style: TextStyle(color: Color(0xFF25AE4B), fontSize: 12.sp)),
                      ),
                      Positioned(
                        right: 0,
                        bottom: 32,
                        child: Text('20 JD', style: TextStyle(color: Color(0xFF25AE4B), fontSize: 12.sp)),
                      ),
                    ],
                  ),
                  ...
                  Stack(
                    children: [
                      ...
                      Positioned(
                        left: 0,
                        bottom: 20.h,
                        child: Text('0%', style: TextStyle(color: Color(0xFF25AE4B), fontSize: 12.sp)),
                      ),
                      Positioned(
                        right: 0,
                        bottom: 20.h,
                        child: Text('50%', style: TextStyle(color: Color(0xFF25AE4B), fontSize: 12.sp)),
                      ),
                    ],
                  ),
                  ...
                  Wrap(
                    ...
                    children: [
                      FilterChip(
                        label: Text('Fast Food', style: TextStyle(fontSize: 12.sp)),
                      ...
                      FilterChip(
                        label: Text('Sea Food', style: TextStyle(fontSize: 12.sp)),
                      ...
                      FilterChip(
                        label: Text('Dessert', style: TextStyle(fontSize: 12.sp)),
                  ...
                  Wrap(
                    ...
                    children: [
                      FilterChip(
                        label: Text('Tuna Tartare', style: TextStyle(fontSize: 12.sp)),
                      ...
                      FilterChip(
                        label: Text('Spicy Crab Cakes', style: TextStyle(fontSize: 12.sp)),
                      ...
                      FilterChip(
                        label: Text('Seafood Paella', style: TextStyle(fontSize: 12.sp)),
                      ...
                      FilterChip(
                        label: Text('Clam Chowder', style: TextStyle(fontSize: 12.sp)),
                      ...
                      FilterChip(
                        label: Text('Miso-Glazed Cod', style: TextStyle(fontSize: 12.sp)),
                      ...
                      FilterChip(
                        label: Text('Lobster Thermidor', style: TextStyle(fontSize: 12.sp)),
