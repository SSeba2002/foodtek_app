...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void addToCart() {
    print('Added to Cart: ${widget.product.name}, Quantity: $quantity, Spicy Level: ${spicyLevel == 0.0 ? 'Mild' : 'Hot'}');

  ScaffoldMessenger.of(context).showSnackBar(
  SnackBar(
  content: Text('${widget.product.name}Added to cart' , textAlign: TextAlign.center,),
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: quantity == 1 ? Colors.white : Colors.green,
                                          border: Border.all(
                                            color: Colors.green,
                                            width: 1.w,
                                          ),
                                        ...
                                        child: Center(
                                          child: Icon(
                                            Icons.remove,
                                            size: 14.w,
                                            color: quantity == 1 ? Colors.green : Colors.white,
                                          ),
                                        ),
                                      ),
                                    ),
